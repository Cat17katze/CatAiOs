...
function install(getAPM,getSKY)
  ...
  eta(items,7,os.time()-startInstall)
  ...
  eta(items,8,os.time()-startInstall)
  ...
  eta(items,11,os.time()-startInstall)
  wget("https://raw.githubusercontent.com/TheAio/CatAiOs/main/src/example.bf",".recolor")
  eta(items,12,os.time()-startInstall)
  wget("https://raw.githubusercontent.com/TheAio/CatAiOs/main/src/recolor.lua",".recolor")
  eta(items,13,os.time()-startInstall)
  if getSKY then
